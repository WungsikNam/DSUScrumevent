...
function publicRoom(room) {
  return {
    ...
    typingGame: room.typingGame ? { round: room.typingGame.round, maxRounds: room.typingGame.maxRounds, phrase: room.typingGame.phrase, roundStartTime: room.typingGame.roundStartTime, roundWinner: room.typingGame.roundWinner, nextRoundAt: room.typingGame.nextRoundAt } : null,
...
module.exports = { getRoom, setRoom, joinRoom, leaveRoom, startGame, recordPress, startReactionGame, recordReaction, startColorGame, recordColorTap, startEmojiGame, recordEmojiTap, startTypingGame, recordTypingSubmit, checkTimeouts, resetToLobby, publicRoom };
